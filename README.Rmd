...
Plan: to try develop a package with functions that make interacting with the UK police data archive easier. 
...
```{r availability-plot, include = F, dev='png', fig.show='hide'}
library(dplyr)
library(magrittr)
library(ggplot2)
...
# ggsave(filename = "plots/plot_hmo_pc_time.png", plot_hmo_pc_time) 

```


![availability-plot.](`r knitr::fig_chunk('availability-plot', 'png')`)
