...
Function fs_report supplies more details about a given police force, data series, and time span. When police force, data series, and time span are specified, the function returns a plot summarising the presence/absence of the relevant files across the relevant folders. The plot additionally highlights which folders would be downloaded/ files would be extracted by the function arc_extract(). Here's an example:
...
plt <- dpukarchive:::fs_graph(police_force = "wiltshire", data_series = "stop-and-search", month_min = "2019-01", month_max = "2024-06", tile_colours = c("#a4a5a4", "#8bce7b", "#17a420"))
